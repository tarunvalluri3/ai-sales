...
/**
 * On-demand AI conversation summary (2026-09-11 inbox redesign) -- see
 * `lib/conversation-summary.ts` for why this is on-demand rather than
 * auto-generated on every poll tick. `currentMessageCount` is the
 * server-rendered transcript length as of page load (not live-updated by
 * `LiveConversationPanel`'s own poll) -- close enough for a "N new
 * messages" nudge without wiring cross-component live state for a
