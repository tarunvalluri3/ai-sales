 ...
 * pane and the conversation detail page's info panel. Deliberately not
 * exhaustive: an unrecognized value (e.g. a future "instagram") falls
 * back to the raw source string, so a new channel reads sensibly
