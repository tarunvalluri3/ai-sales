...
A rollback was live-verified during Phase 20: `vercel rollback` against a deliberately-broken deploy restored the previous good deployment as the active production URL within the platform's normal propagation time, confirming this is a real, working escape hatch and not just a documented assumption.
